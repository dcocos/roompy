...
from calendar_module.CalendarManager import CalendarManager
...
class TestCalendarManager(unittest.TestCase):
    ...
    def test_is_event_open_yes(self):
        calendar_manager = CalendarManager(self.calendar_client)
    ...
    def test_get_open_meetings(self):
        calendar_manager = CalendarManager(self.calendar_client)
        result_list = calendar_manager.get_open_meetings(self.time_now)
